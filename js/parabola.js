...
// 转化为整数
    ...
    Parabola.prototype = {
        ...
        initialize: function (options) {
            ...
            //运动到目标节点的位置
            if (ops.targetEl) {
                //目标节点的left值 - 运动节点的初始位置的left值
                this.driftX = toInteger(_$(ops.targetEl).css("left")) - this.elOriginalLeft;//运动节点要便宜的x轴方向的距离
                this.driftY = toInteger(_$(ops.targetEl).css("top")) - this.elOriginalTop;//y轴方向上的距离
            } else {
